...
- ~v8.0.300~ 8.0.130 (there was no 8.0.109?)
...
- NET9: v9.0.100->v9.0.120 (SDK version != runtime version. Ask Microsoft why they are disjointed) 
- NET10: v10.0.100-preview.1.25120.13->v10.0.111 / v10.0.202 ( Note: 10.0.4 as SDK 10.0.200 or 10.0.104 is not built as it was quickly replaced by x.201 and x.105)
